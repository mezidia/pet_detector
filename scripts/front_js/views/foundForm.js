  ...
  return `<div class="container" style="max-width: 550px;"><form action="/" method="POST">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="exampleTextarea" rows="3" placeholder="Можете зазначити особливі прикмети тварини чи місце де ви знайшли її, надати більш детальний опис." ></textarea>
      ...
      <button type="submit" id="recaptcha-submit" class="btn btn-primary">Відправити</button>
    </form>
    </div>`
}
